...
coverflowimages({
    coverid: 'coverflow1',
    images: [
        ['image1.jpg', 'Emotional melodies that stand the test of time'],
        ['image2.jpg', 'Captivating tunes for the romantic soul'],
        ['image3.jpg', 'Soulful rhythms that tell the story of the blues'],
        ['image4.jpg', 'Rhythmic beats and smooth vocals define these RnB hits'],
        ['image5.jpg', 'Journey through the golden era of hit songs'],
        ['image6.jpg', 'Experience the magic of beautiful love songs'],
    ]
})